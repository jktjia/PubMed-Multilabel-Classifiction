...
\emph{What is this project about? Goals, motivation, etc...}
...
MeSH labels are arranged into a nested hierarchy with 16 root labels. Each article has up to 13
root labels, with a median root label count of six. Two labels---Humanities [K] and Publication
Characteristics [V]---have been ignored due to their infrequency in the available data. Across
50,000 sample articles, exactly one sample has label K and none have label V. The 12 included
labels each appear in at least ten percent of the sample articles.
...
\begin{table*}
	[p]
	\centering
	\captionof{table}{Labels} \label{tab2:title}
	\begin{tabular}{ c l }
		\Xhline{1.5pt}
